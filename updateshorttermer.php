...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Update</span> Short Termer Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to Update all your registered details for Short Termer Prisoners</p>
		  </div>
		  ...
		  <?php
               ...
               $id=$_GET["id"]; 
                ...
                $select="select * from shorttermers where Id=$id";
        ...
        ?>
		  ...
		  <form action="editshorttermer.php?id=<?php echo $row['Id']; ?>" enctype="multipart/form-data" method="post" style="margin-left:90px;">
   ...
   <div id="tab4" class="tabcontent">
      <!--  <h3>Booking Form for  my clients</h3>  -->
        <div class="form">
            ...
            <input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Convict Number" name="convict" required onKeyUp="checkInput(this)" value="<?php echo $row['ConvictNo']; ?>"   /> 
		</li>
            <li>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Earliest Date Of Discharge" name="edate" id="datefield4"  required value="<?php echo $row['EarliestDate']; ?>"  />
	  </li>

	  <li>
	<label>Latest Date Of Discharge :  </label>
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Latest Date Of Discharge" name="ldate" id="datefield5"  required value="<?php echo $row['LatestDate']; ?>" />
	  </li>
...
<option><?php echo $row['District'];?></option>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Sentence" name="sentence" required value= "<?php echo $row['Sentence']; ?> " />
	  </li>
  <li>
		  <label>Photo :</label>
	    ...
	    <input type="submit" class="form_submit" value="Update Short Termer Prisoner" style="width:450px;height:30px; margin-right: 48px; margin-top:5px"  name="save" />
