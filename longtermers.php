  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
         <div class="article">
          <h2><span>Register</span>  Long Termer Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to register all your details for Long Termer Prisoners</p>
		  </div>
		  <form action="longtermers.php" method="post" enctype="multipart/form-data" id="sendemail" style="margin-left:90px;">
            <ol>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Sentence" name="sentence" required  />
      ...
      <div class="sidebar">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="#">Registered Prisoners</a></li>
            <li><a href="#">Registered Long Termers</a></li>
