...
$insert="update non_Committal set Non_CommittalNo='$convict', FirstName='$fname',SecondName='$lname',SonOf='$son',Gender='$gender',DOB='$dob',Offence='$offence',TypeOfPrisoner='$prisoner',Court='$court',MaritalStatus='$ms',AdmissionDate='$adate',ConvictionDate='$cdate',Description='$description',NextOfKin='$kin',Telephone='$tel',District='$district',Photo='$location'   where Id=$id";
