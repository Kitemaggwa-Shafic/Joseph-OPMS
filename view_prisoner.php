...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span> Convict Prisoner Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered convict prisoners in the prison.<br />
		This form will show you all the details registered for all convict prisoners and then in case you want to edit a given prisoner,
...
<table id="rounded-corner" style="margin-left:-330px;">
