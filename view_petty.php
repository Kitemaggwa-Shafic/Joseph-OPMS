...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span> Petty Offender Prisoner Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered Petty Offender prisoners in the prison.<br />
		This form will show you all the details registered for all Petty Offender prisoners and then in case you want to edit a given prisoner,
...
<table id="rounded-corner" style="margin-left:-130px;">
...
echo'<td>'.$row["District"].'</td>';	
  ?>
    ...
    <td><a href="update_petty.php?id=<?php echo $row['Id']; ?>" ><img src="images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="deletepetty.php?id=<?php echo $row['Id']; ?>" ><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
