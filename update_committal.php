      ...
      <div class="mainbar">
		  ...
		  <?php
               ...
               $id=$_GET["id"]; 
                ...
                $select="select * from committal where Id=$id";
        ...
        ?>
		  ...
		  <form action="editcommittal.php?id=<?php echo $row['Id']; ?>" enctype="multipart/form-data" method="post" style="margin-left:90px;">
   ...
   <div id="tab4" class="tabcontent">
      <!--  <h3>Booking Form for  my clients</h3>  -->
        <div class="form">
            ...
            <input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Convict Number" name="convict" required onKeyUp="checkInput(this)" value="<?php echo $row['CommittalNo']; ?>"   /> 
		</li>
            <li>
...
<option><?php echo $row['District'];?></option>
  ...
  <li>
	    ...
	    <input type="submit" class="form_submit" value="Update Convict Prisoner" style="width:450px;height:30px; margin-right: 48px; margin-top:5px"  name="save" />
