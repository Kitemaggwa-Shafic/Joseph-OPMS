...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Update</span>Long Termer Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to Update all your registered details for Long Termer Prisoners</p>
		  </div>
		  ...
		  <?php
               ...
               $id=$_GET["id"]; 
                ...
                $select="select * from longtermers where Id=$id";
        ...
        ?>
		  ...
		  <form action="editlongtermer.php?id=<?php echo $row['Id']; ?>" enctype="multipart/form-data" method="post" style="margin-left:90px;" >
...
<option><?php echo $row['District'];?></option>
  ...
  <li>
	    ...
	    <input type="submit" class="form_submit" value="Update LongTermer Prisoner" style="width:450px;height:30px; margin-right: 48px; margin-top:5px"  name="save" />
