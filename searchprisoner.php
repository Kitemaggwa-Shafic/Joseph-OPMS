...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Search</span> Convict Prisoner Details.</h2>	  
        <div class="clr"></div>
 		<p>You will use this form to to show all the details of the registered convict prisoners in the prison.<br />
		<form action="print.php" method="post">
		 
        <p ><h2 style="margin-left:70px;"> Enter First Name</h2> <input type="text" style="width:450px;height:25px" class="textbox" placeholder="Enter Prisoners First Name" name="fname"  /> </p>
	<p><input type="submit" class="form_submit" value="SEARCH PRISONER DETAILS" style="width:450px;height:25px"  name="search" /> </p>
	<!--		    <p style="margin-left:150px;"> <a href="print.php"><img src="images/print_button.jpg" input name="print" type="button" value="Print" id="printButton" onClick="printpage()"></a> </p>
		 -->	
		</div>

 <table id="rounded-corner" style="margin-left:-420px; width:1250px;">
 ...
 <tbody>
	 ...
	 if(isset($_POST["search"]) && !empty($_POST["fname"])){
        $firstname=$_POST['fname'];
                ...
                $select="select * from convict where FirstName LIKE '%$firstname%' ";
