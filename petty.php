...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Register</span>  New Petty Offender Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to register all your details for Petty Offender  Prisoners</p>
		  </div>
          <form action="petty.php" method="post" enctype="multipart/form-data" id="sendemail" style="margin-left:90px;">
            <ol>
   ...
   <div id="tab4" class="tabcontent">
      <!--  <h3>Booking Form for  my clients</h3>  -->
        <div class="form">
			...
			<li>
            <label> Petty Number :</label>
            <input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Prisoner Petty Number" name="petty" required onKeyUp="checkInput(this)"   /> 
		</li>
            <li>
...
<option value="" >------------------------Select District--------------------------</option>
	  ...
	  <li>
	    ...
	    <input type="submit" class="form_submit" value="Register Petty Offender Details" style="width:450px;height:30px; margin-right: 48px; margin-top:5px"  name="save" />
      ...
      <div class="sidebar">
          ...
          <div class="clr"></div>
          <ul class="sb_menu_com">
            <li><a href="#">Home</a></li><br />
			<li><a href="#">Registered Staff</a></li><br />
            ...
            <li><a href="view_petty.php">Registered Petty Offenders</a></li><br />
