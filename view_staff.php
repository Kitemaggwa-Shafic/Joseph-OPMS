...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span> Staff Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered Staff in the prison.<br />
		This form will show you all the details registered for all Staff and then in case you want to edit a given prisoner,
...
echo'<td>'.$row["DateOfEnlishment"].'</td>';	
echo'<td>'.$row["NumberOfChildren"].'</td>';	
  ?>
    ...
    <td><a href="update_staff.php?id=<?php echo $row['Id']; ?>" ><img src="images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="delete_staff.php?id=<?php echo $row['Id']; ?>" ><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
