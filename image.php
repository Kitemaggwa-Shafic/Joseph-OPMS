<form name="file" action="image.php" method="post" enctype="multipart/form-data">
...
mysql_select_db('prison') or die("Unable to select the DB.");
mysql_query("INSERT INTO files SET image='$file_contents'") or die("MySQL Query Error: " . mysql_error() . "<br><br>". "The SQL was: $SQL<br><br>");
mysql_close();
