...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Update</span>Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to Update all your registered details for Convict Prisoners</p>
		  </div>
		  ...
		  <?php
               ...
               $id=$_GET["id"]; 
                ...
                $select="select * from convict where Id=$id";
        ...
        ?>
		  ...
		  <form action="edit.php?id=<?php echo $row['Id']; ?>" method="post" style="margin-left:90px;">
            <ol>
...
<option><?php echo $row['District'];?></option>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Sentence" name="sentence" required value= "<?php echo $row['Sentence']; ?> " />
      ...
      <div class="sidebar">
          ...
          <ul class="sb_menu">
            <li><a href="#">Home</a></li>
			<li><a href="#">Registered Staff</a></li>
            <li><a href="view_prisoner.php">Registered Prisoners</a></li>
            <li><a href="view_longtermers.php">Registered Long Termers</a></li>
            <li><a href="#">Registered Short Termers</a></li>
            <li><a href="#">Registered Petty Offenders</a></li>
            <li><a href="#">Registered Committal</a></li>
          </ul>
