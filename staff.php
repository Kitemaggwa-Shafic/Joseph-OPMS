...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Register</span> New Staff Officer Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to register all your Officer Details</p>
		  </div>
          <form action="staff.php" method="post" enctype="multipart/form-data" id="sendemail" style="margin-left:90px;">
            <ol>
   ...
   <div id="tab4" class="tabcontent">
      <!--  <h3>Booking Form for  my clients</h3>  -->
        <div class="form">
            ...
            <input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Staff Number" name="staff" required onKeyUp="checkInput(this)"   /> 
		</li>
            <li>
 	...
 	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Last Name"  name="lname" required   onKeyUp="checkInput(this)"  />
	  ...
	  <select name="rank" style="width:455px;height:33px" class="form_select">
                                    <option value="" selected="selected">------------------------Select Rank Name-----------------------</option>
  ...
  <li>
        ...
        <option value="" selected="selected">------------------------Select Deployment Status-----------------------</option>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Level Of education" name="education"   required  />
	  </li>
...
<option value="" >------------------------Select District--------------------------</option>
	...
	<input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Date Of Enlistment " name="edate" id="datefield2"  required  />
	  </li>
	  
	  <li>
            <label>Number Of Children :</label>
             <input type="text" class="form_input" style="width:450px;height:25px" class="textbox" placeholder="Enter Number Of Children" name="child" required onKeyUp="checkInput1(this)" />
	  ...
	  <li>
	    ...
	    <input type="submit" class="form_submit" value="Register Staff Details" style="width:450px;height:30px; margin-right: 48px; margin-top:5px"  name="save" />
