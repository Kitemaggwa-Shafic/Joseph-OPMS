...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span> Non-Committal Prisoner Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered Non-Committal prisoners in the prison.<br />
		This form will show you all the details registered for all Non-Committal prisoners and then in case you want to edit a given prisoner,
...
<table id="rounded-corner" style="margin-left:-210px;">
     
    	<tr bgcolor="#0009966" style="color:#FFFFFF">
   
   <thead align="center">	
				<th>Non-Committal Number</th>
                <th>First Name</th>
				<th>Second Name</th>  
				<th>Son Of</th>
				<th>Gender</th>
 ...
 <tbody>
	 ...
	 <?php
                ...
                $select="select * from non_committal ";
                ...
                echo'<td>'.$row["Non_CommittalNo"].'</td>';  
...
echo'<td>'.$row["District"].'</td>';	
  ?>
    ...
    <td><a href="update_ncommittal.php?id=<?php echo $row['Id']; ?>" ><img src="images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="delete_ncommittal.php?id=<?php echo $row['Id']; ?>" ><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
