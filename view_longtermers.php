...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span>Long Termer Prisoner Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered Long Termer prisoners in the prison.<br />
		This form will show you all the details registered for all Long Termer prisoners and then in case you want to edit a given prisoner,
...
<?php
					include ('db.php');
					$sno =0;
					$query = mysql_query("select * from longtermers") or die(mysql_error());
					...
					<tr bgcolor="<?php echo $color;?>" style="color:#000000" align='center' >
 			<td><?php echo $row['ConvictNo'];?></td>
			...
			<td><?php echo $row['TypeOfPrisoner']; ?></td>
			<td><?php echo $row['Court']; ?></td>
			<td><?php echo $row['MaritalStatus']; ?></td>
			<td><?php echo $row['AdmissionDate'];?></td>
			<td><?php echo $row['ConvictionDate'];?></td>
			<td><?php echo $row['EarliestDate'];?></td>
			<td><?php echo $row['LatestDate'];?></td>
    ...
    <td><a href="updatelongtermer.php?id=<?php echo $row['Id']; ?>" ><img src="images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="deletelongtermer.php?id=<?php echo $row['Id']; ?>" ><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
