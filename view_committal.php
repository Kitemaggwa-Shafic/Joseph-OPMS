...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
        <h2><span>Registered</span> Committal Prisoner Details.</h2>	  
        <div class="clr"></div>
		<p>You will use this form to to show all the details of the registered Committal prisoners in the prison.<br />
		This form will show you all the details registered for all Committal prisoners and then in case you want to edit a given prisoner,
	 ...
	 <form action="committal.php" method="post">
<table id="rounded-corner" style="margin-left:-290px;">
     
    	<tr bgcolor="#0009966" style="color:#FFFFFF">
   
   <thead align="center">	
				<th>Committal Number</th>
                <th>First Name</th>
				<th>Second Name</th>  
				<th>Son Of</th>
				<th>Gender</th>
...
echo'<td>'.$row["District"].'</td>';	
  ?>
    ...
    <td><a href="update_committal.php?id=<?php echo $row['Id']; ?>" ><img src="images/edit.png" alt="" title="" border="0" /></a></td>
            <td><a href="deletecommittal.php?id=<?php echo $row['Id']; ?>" ><img src="images/trash.gif" alt="" title="" border="0" /></a></td>
