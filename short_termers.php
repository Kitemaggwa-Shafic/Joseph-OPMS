...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
          <div class="article">
          <h2><span>Register</span>  Short Termer Prisoner Details</h2>
          <div class="clr"></div>
		   <p style="margin-left:90px;">You will use this form to register all your details for Short Termer Prisoners</p>
		  </div>
          <form action="shorttermers.php" method="post" enctype="multipart/form-data" id="sendemail" style="margin-left:90px;">
            <ol>
